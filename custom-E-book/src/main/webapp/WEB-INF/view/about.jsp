								...
								<c:choose>
									<c:when test="${price==hardCopyPrice}">
										<table class="table table-striped" style="font-weight: bold;">
											<tr>
												<td style="width: 175px;"><label for="name">Name:</label></td>
												<td><input class="form-control" name="name"
													required="required" type="text" value="${buyer.name }" /></td>
											</tr>
											<tr>
												<td style="width: 175px;"><label for="email">Email:</label></td>
												<td><input class="form-control" name="email"
													required="required" type="text" value="${buyer.email}" /></td>
											</tr>
											<tr>
												<td style="width: 175px;"><label for="addr">Address:</label></td>
												<td><textarea name="addr" rows="3" required></textarea></td>
											</tr>
											<tr>
